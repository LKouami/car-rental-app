...
const messages = [
    ['Oups.', 'Oups.', 'Excusez-nous.', 'Oh !.', 'Eh bien merde.', 'Hum...', "C'est gênant.", 'Eh bien ça alors !'],
    ['Il semble', 'On dirait', 'Malheureusement',  'Malheureusement' ],
    ['il y a eu une erreur.', 'vous avez fait une gaffe.', "une mauvaise page a été demandée.", 'Cette page est introuvable.'],
    ['Désolé.', 'Changez de page.'],
  ];
