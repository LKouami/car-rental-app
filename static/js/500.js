...
const messages = [
    ['Oups.', 'Oups.', 'Excusez-nous.', 'Oh !.', 'Eh bien.', 'Hum...', "C'est gênant.", 'Eh bien ça alors !'],
    ['Il semble', 'On dirait', 'Malheureusement', "C'est juste comme ça", 'Malheureusement', 'Apparemment de nulle part'],
    ['il y a eu une erreur.', 'nous avons fait une gaffe.', "un bug s'est produit.", 'le serveur a planté.', 'un bug est apparu.', "quelqu'un a fait quelque chose.", 'des lutins sont entrés dans le server !', 'le serveur a fait une crise de colère.', 'le site Web a eu une mauvaise journée.', 'notre code a crashé.'],
    ['Désolé.', 'Nos excuses.', 'Notre Faute.', 'Triste journée.', 'Nous sommes assez désolé.', 'Pardon.']
  ];
